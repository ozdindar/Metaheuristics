...
public class MOTAPScalability2TestCases {
	    ...
	    /*PARAMETER TUNING*/
	    public static List<ITestCaseGenerator> MetaHeuristics = Arrays.asList(new PMBOCases(), new IslandEACases(), new IslandMBOCases());
	    ...
	    public static class PMBOCases implements ITestCaseGenerator{
	        ...
	        public static int poolSizes[] = {256,512};
	    ...
	    public static class IslandEACases implements ITestCaseGenerator{
	        ...
	        private static final int[] poolSizes  =   {256,512};
