package problems.bbob.f8_rosenbrock;
 ...
 */
public class Rosenbrock extends AbstractBBOBProblem {
    ...
    public double evaluate(double[] x) {
        ...
        // Compute z = scaling * (x - xOpt) + 1
        for (int i = 0; i < D; i++) {
            z[i] = scaling * (x[i] - xOpt[i]) + 1.0;
        }
    ...
    public static void main(String[] args) {
        ...
        Rosenbrock as = new Rosenbrock(dimension);
