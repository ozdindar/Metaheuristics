...
public class movmain {
	/*public MovingPeaks( int numberOfAttractors,
     ...
     * @uml.associationEnd
     */
    private MovingPeaks FktnLib = new MovingPeaks();
    //Scenario 1
    //private MovingPeaks FktnLib = new MovingPeaks(5,5,5000,2,0.0002,0.2,0.1, 0.0,7.0,0.01,);
    //Scenario 2
    //private MovingPeaks FktnLib = new MovingPeaks();
    //Scenario 3
    //private MovingPeaks FktnLib = new MovingPeaks();
            ...
            switch (arg.charAt(1)) {
                ...
                case 'e' :
                    ...
                    if (arg.equals("-econe")) {
                        ...
                        this.FktnLib.scenario.setPf(new Peak_Function_Cone());
                        System.gc();
                        ...
                        if (arg.equals("-ehilly")) {
                            ...
                            this.FktnLib.scenario.setPf( new Peak_Function_Hilly());
                            System.gc();
                            ...
                            if (arg.equals("-etwin")) {
                                ...
                                this.FktnLib.scenario.setPf(new Peak_Function_Twin());
                                System.gc();

                            } else {

                                if (arg.equals("-e1")) {
                                    this.FktnLib.scenario.setPf(new Peak_Function1());
                                    System.gc();
                                }
                            }
                ...
                case 'b' :
                    ...
                    if (arg.equals("-bconst")) {
                        ...
                        this.FktnLib.scenario.setBf(new Constant_Basis_Function());
                        System.gc();
                ...
                case 'Y' :
                    ...
                    try {
                        ...
                        if (newdouble < -0.05 || newdouble > 1.05) {
                            ...
                            FktnLib.scenario.setLambda( newdouble);
                        }
