...
public class RAPBenchmarks {
    ...
    public static RAPS createBMInstance(int nmax, int cost, int weight) {
        ...
        return new RAPS(cost, weight, nmax, components, k);


    }

    public static RAPS[] createBMInstances(int nmax, int costs[], int weights[]) {

        RAPS[] raps= new RAPS[costs.length*weights.length];
