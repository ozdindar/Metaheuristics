...
public class RBeamSearch extends AbstractSMetaheuristic {
    ...
    public RBeamSearch(int releaseCount, int depth, int maxIterationCount, RBeamChildGenerator childGenerator, ReleaseHandler releaseHandler) {
        this.depth = depth;
    ...
    public RBeamSearch(RBeamSearch rBeamSearch) {
        super(rBeamSearch);
    ...
    public AbstractSMetaheuristic clone() {
        AbstractSMetaheuristic clone = new RBeamSearch(this);
                new RBeamSearch(releaseCount,depth,maxIterationCount,childGenerator.clone(),releaseHandler.clone());
        return clone;
    }
