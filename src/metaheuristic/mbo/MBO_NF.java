 ...
 *
 */
public class MBO_NF extends AbstractMetaheuristic
{
    ...
    public MBO_NF(List<NeighboringFunction> neighboringFunctions, TerminalCondition terminalCondition, int nPopulation, int nTours, int nNeighbourSolutions, int nSharedNSolutions) {
    ...
    private static final int LeaderSearchCount =5;// was 5
    private Individual improveLeaderCandidate(OptimizationProblem problem, Individual neighbor) {
        ...
        for (int i=0;i<LeaderSearchCount;i++) {
            ...
            Individual tmp = neighboringFunctions.get(nf).apply(problem, neighbor);
    ...
    private Individual createNeighbor(OptimizationProblem problem, Individual individual) {
        ...
        Individual neighbor = neighboringFunctions.get(nf).apply(problem,individual);;
    ...
    public static MetaHeuristic createInstance(OptimizationProblem problem, String[] params) {
        ...
        List<NeighboringFunction> neighborFunctions = TabuService.NeighboringFunctions.createNeighboringFunctions(params[0],problem);
        ...
        MBO_NF mbo = new MBO_NF(neighborFunctions,terminalCondition,nPopulation,nTours,nNeighborSolutions,nSharedNSolutions);
